...
extern NSString *const DUOpenBSDBackendDetailKey;

// OpenBSD implementation of the storage abstraction. Discovery is delegated
// to DUOpenBSDDeviceDiscovery; filesystem, partition, mount and image work
...
@interface DUOpenBSDStorageBackend : NSObject <DUStorageBackend>
